...
namespace MVC_TM.Models
{
    ...
    public class ReviewPageTotal : ReviewPage
    {
    ...
    public class TaxCityInfo
    {
        public Int32 PCTIID { get; set; }
        public Int32 PCTI_PlaceID { get; set; }
        public Int32 PCTI_CountryID { get; set; }
        public string PCTI_CityName { get; set; }
        public string PCTI_CountryName { get; set; }
        public string PCTI_CityTaxDescription{ get; set; } 
        public Int32 STR_UserID { get; set; }
        public Int32 PCTI_Active { get; set; }
    ...
    {
        public Int32 IAEMID { get; set; }
        public string IAEM_Brand { get; set; }
        public string IAEM_Model { get; set; }
        public string IAEM_Doors { get; set; }
    ...
    public class ErrorMessage
    {
        ...
        public string routeOfException_ { get; set; }
        public string stackTrace_ { get; set; }
