...
$(document).ready(function(){
	...
	var options = {};
	options.url = SiteName + "/Api/sqlReviewFirst";
	options.type = "POST";
...
function callReviewData(pg) {
	...
	var options = {};
	options.url = SiteName + "/Api/sqlReviewPage";
	options.type = "POST";
	options.contentType = "application/json";
		...
		rvData = data;
	        ...
	        jQuery.each(rvData, function(rvData) {
	            ...
	            if (rvType == 1) {
	                ...
	                nwDv = nwDv + '<span class="spEaReLeLine"><font class="fntLightText">(' + this.NoOfFeed + ' of reviews)</font></span>';
