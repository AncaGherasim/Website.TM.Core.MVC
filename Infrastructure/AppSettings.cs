...
namespace MVC_TM.Infrastructure
{
    public class AppSettings
    {
        ...
        public class connstr
        {
            ...
            public string sqlVisitsConnStr { get; set; }
            public string DevAurora { get; set; }
            public string ProAurora { get; set; }
        }
        ...
        public class appstgs
        {
            ...
            public string TMLD_userID { get; set; }
            public string TMLD_intCom { get; set; }
            ...
            public string TMED_userID { get; set; }
            public string TMED_intCom { get; set; }
            ...
            public string TMAS_userID { get; set; }
            public string TMAS_intCom { get; set; }
        ...
        public emailset EmailSetting { get; set; }
        public class emailset
        {
            public string AwsChatContactType { get; set; }
            public string AwsActiveChats { get; set; }
            public string AwsOutboundCall { get; set; }
        }
    }
