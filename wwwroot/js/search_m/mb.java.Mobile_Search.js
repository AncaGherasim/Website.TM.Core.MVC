$(document).ready(function () {
    ...
    //    $('div[id^="optPrice"]').removeClass("selectedOptionC").addClass("unselectedOptionC");
    //    $(this).removeClass("unselectedOptionC").addClass("selectedOptionC");
    //});
    $('#ClearFilter_optPrice').click(function() { $('div[id^="optPrice"]').removeClass("selectedOptionC").addClass("unselectedOptionC"); });


    //$('div[id^="optLenght"]').click(function() {
    //    $('div[id^="optLen"]').removeClass("selectedOptionC").addClass("unselectedOptionC");
    //    $(this).removeClass("unselectedOptionC").addClass("selectedOptionC");
    //});
    $('#ClearFilter_optLenght').click(function() { $('div[id^="optLenght"]').removeClass("selectedOptionC").addClass("unselectedOptionC"); });
...
function BuildFilterExpression() {
    var priceFilter = ''
    $('div.selectedOptionC[id^="optCkPrice"]').each(function() {
        priceFilter = priceFilter + $(this).attr("id").replace("optCkPrice","") + 'P';
    });
    priceFilter = priceFilter.length > 1 ? priceFilter.substring(0, priceFilter.length - 1) : priceFilter;

    var lengthFilter = ''
    $('div.selectedOptionC[id^="optCkLenght"]').each(function() {
        lengthFilter = lengthFilter + $(this).attr("id").replace("optCkLenght","") + 'L';
    });
