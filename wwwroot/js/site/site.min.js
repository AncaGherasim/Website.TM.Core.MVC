function getDistanceFromLatLonInKm(n,t,i,r){var u=deg2rad(i-n),f=deg2rad(r-t),e=Math.sin(u/2)*Math.sin(u/2)+Math.cos(deg2rad(n))*Math.cos(deg2rad(i))*Math.sin(f/2)*Math.sin(f/2),o=2*Math.atan2(Math.sqrt(e),Math.sqrt(1-e));return 6371*o}function deg2rad(n){return n*(Math.PI/180)}function ObjectPosition(n){var t=0,i=0;if(n.offsetParent)do t+=n.offsetLeft,i+=n.offsetTop;while(n=n.offsetParent);return[t,i]}function showPopUp(n){var t,i,r,u;i=ObjectPosition(document.getElementById(n));u=i[0]-5+"px";r=i[1]+16+"px";n.indexOf("Partially")!=-1?(t='<div style="padding:0px 0px 7px 0px;"><b>Partially Guided:<\/b><\/div>',t=t+"<div>"+$("#inpparGuided").val().replace(".",".<br><br>")+"<\/div>"):n.indexOf("none")!=-1?(t='<div style="padding:0px 0px 7px 0px;"><b>None:<\/b><\/div>',t=t+"<div>has no value<\/div>"):(t='<div style="padding:0px 0px 7px 0px;"><b>Guided:<\/b><\/div>',t=t+"<div>"+$("#inpGuided").val().replace(".",".<br><br>")+"<\/div>");dvMpop=$('<div id="dvMess" class="Text_12_Blue"><\/div>');$("body").append(dvMpop);$("#dvMess").html(t);$("#dvMess").attr("style","left:"+u+"; top:"+r+"; position:absolute; display:block; border:solid 1px black; width:300px; padding:10px; background-color:#FFF;");$("#dvMess").show()}function hidePopUp(){$("#dvMess").hide()}function MM_findObj(n,t){var u,r,i;for(t||(t=document),(u=n.indexOf("?"))>0&&parent.frames.length&&(t=parent.frames[n.substring(u+1)].document,n=n.substring(0,u)),(i=t[n])||!t.all||(i=t.all[n]),r=0;!i&&r<t.forms.length;r++)i=t.forms[r][n];for(r=0;!i&&t.layers&&r<t.layers.length;r++)i=MM_findObj(n,t.layers[r].document);return!i&&t.getElementById&&(i=t.getElementById(n)),i}function MM_swapImage(){var t,r=0,n,i=MM_swapImage.arguments;for(document.MM_sr=[],t=0;t<i.length-2;t+=3)(n=MM_findObj(i[t]))!=null&&(document.MM_sr[r++]=n,n.oSrc||(n.oSrc=n.src),n.src=i[t+2])}function MM_swapImgRestore(){for(var t,i=document.MM_sr,n=0;i&&n<i.length&&(t=i[n])&&t.oSrc;n++)t.src=t.oSrc}function MM_preloadImages(){var n=document,t,r,i;if(n.images)for(n.MM_p||(n.MM_p=[]),r=n.MM_p.length,i=MM_preloadImages.arguments,t=0;t<i.length;t++)i[t].indexOf("#")!=0&&(n.MM_p[r]=new Image,n.MM_p[r++].src=i[t])}function MM_openBrWindow(n,t,i){window.open(n,t,i)}function IsMobileDevice(){return navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/webOS/i)||navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/iPad/i)||navigator.userAgent.match(/iPod/i)||navigator.userAgent.match(/BlackBerry/i)||navigator.userAgent.match(/Windows Phone/i)||navigator.userAgent.match(/Windows mobile/i)||navigator.userAgent.match(/IEMobile/i)||navigator.userAgent.match(/Opera Mini/i)?!0:!1}function checkImg(n,t,i){var r=new Image;r.onload=function(){$("#"+n+"").html('<img src="'+t+'"/>')};r.onerror=function(){$("#"+n+"").html('<img src="'+i+'"/>')};r.src=t}function checkSpotImg(n,t,i){var r=new Image;r.onload=function(){$("#"+n+"").html('<img src="'+t+'"/>')};r.onerror=function(){$("#"+n+"").html('<span class="spselect">'+i+"<\/span>")};r.src=t}function setCookie(n,t,i){var r=new Date;r.setTime(r.getTime()+i*864e5);document.cookie=n+"="+escape(t)+(i==null?"":";expires="+r.toGMTString())}function getCookie(n){return document.cookie.length>0&&(c_start=document.cookie.indexOf(n+"="),c_start!=-1)?(c_start=c_start+n.length+1,c_end=document.cookie.indexOf(";",c_start),c_end==-1&&(c_end=document.cookie.length),unescape(document.cookie.substring(c_start,c_end))):null}async function getHomeTownAirport(){let t=getItemF("cacheHomeTown"),n="";if(t!=null&&t.indexOf("Unknown")>-1&&(t=null),t==null)try{const t=await fetch(SiteName+"/Api/HomeTownAirport",{method:"POST",headers:{"Content-Type":"application/json"}}),i=await t.json();n=i;n!=""&&(setItemF("cacheHomeTown",n,24),checkCalendar(n))}catch(i){console.error("getHomeTownAirport error:",i)}else n=t,checkCalendar(n)}function checkCalendar(n){if(n!=""&&n!="none"){var i=$("input").filter(function(){return this.id.match(/idLeavingFrom|qLeaveID|qReturnID|iDepCity|iDepCityTxt|xIDLeavingFrom/g)}).attr("id"),t=n.split("|");switch(i){case"idLeavingFrom":($("#idLeavingFrom").val()=="-1"||$("#idLeavingFrom").val()=="")&&($("#txtLeavingFrom").val(t[1]),$("#idLeavingFrom").val(t[0]));break;case"qLeaveID":($("#qLeaveID").val()=="-1"||$("#qLeaveID").val()=="")&&($("#qLeaveNA").val(t[1]),$("#qLeaveID").val(t[0]),$("#qLeaveCO").val(t.length>2?t[2]:""));break;case"qReturnID":$("#qReturnNA").is(":visible")&&($("#qReturnNA").length>0?($("#qReturnNA").val(t[1]),$("#qReturnID").val(t[0])):"");break;case"iDepCity":($("#iDepCity").val()=="-1"||$("#iDepCity").val()=="")&&($("#sDepCity").val(t[1]),$("#iDepCity").val(t[0]),$("#qLeaveID").length>0&&($("#qLeaveNA").val(t[1]),$("#qLeaveID").val(t[0])),$("#qReturnNA").is(":visible")&&($("#qReturnNA").length>0?($("#qReturnNA").val(t[1]),$("#qReturnID").val(t[0])):""));break;case"xIDLeavingFrom":($("#xIDLeavingFrom").val()=="-1"||$("#xIDLeavingFrom").val()=="")&&($("#xtxtLeavingFrom").val(t[1]),$("#xIDLeavingFrom").val(t[0]),$("#xtxtReturningTo").val(t[1]),$("#xIDReturningTo").val(t[0]));break;case"iDepCityTxt":($("#iDepCity").val()=="-1"||$("#iDepCity").val()=="")&&($("#iDepCityTxt").val(t[1]),$("#iDepCity").val(t[0]),$("#iRetCity").val(t[0]))}}}function highlightText(n,t){for(var f=$.trim(n).toLowerCase(),i=t.get(0).firstChild,e,u,r;(e=i.data.toLowerCase().indexOf(f))>=0;)u=i.splitText(e),i=u.splitText(f.length),r=document.createElement("span"),r.className="highlight boldText",i.parentNode.insertBefore(r,i),r.appendChild(u)}function getBusinessDateObj(n){var t=new Date;t.setTime(t.getTime()-0);var r=t.getDay(),i=n,u=r+n;return u>=6&&(n-=6-r,i+=2,bookWeeks=Math.floor(n/5),i+=bookWeeks*2),t.setTime(t.getTime()+i*864e5),t}function stringToDate(n,t,i){var e=t.toLowerCase(),r=e.split(i),u=n.split(i),o=r.indexOf("mm"),s=r.indexOf("dd"),h=r.indexOf("yyyy"),f=parseInt(u[o]);return f-=1,new Date(u[h],f,u[s])}function openWinCMS(n,t){return centerWindow(t),!1}function highlightText(n,t){for(var f=$.trim(n).toLowerCase(),i=t.get(0).firstChild,e,u,r;(e=i.data.toLowerCase().indexOf(f))>=0;)u=i.splitText(e),i=u.splitText(f.length),r=document.createElement("span"),r.className="highlight boldText",i.parentNode.insertBefore(r,i),r.appendChild(u)}function searchGO(n){var t,i;n.indexOf("##P##")!=-1||(t=$("#q").val().replace(/-/g,"").replace(/_/g,""),t==undefined||t==""?t=$("#qm").val().replace(/-/g,"").replace(/_/g,""):"",i="/search?q="+t.replace(/ /g,"_"),location.href=i)}function timeBetween(n,t){var e=n.getTime(),o=t.getTime(),i=o-e,s,r,u,f;return i=i/1e3,s=Math.floor(i%60),i=i/60,r=Math.floor(i%60),i=i/60,u=Math.floor(i%24),f=Math.floor(i/24),f>0?f+(f===1?" day ago":" days ago"):u>0?u+(u===1?" hour ago":" hours ago"):r>0?r+(r===1?" minute ago":" minutes ago"):"  just visited"}function getItemF(n){let t=JSON.parse(localStorage.getItem(n));return t?t.expireTime<=Date.now()?(localStorage.removeItem(n),null):t.data:null}function setItemF(n,t,i){var r=i*36e5;let u={data:t};r&&(u.expireTime=Date.now()+r);localStorage.setItem(n,JSON.stringify(u));console.log("key: "+n)}function removeItemF(n){localStorage.removeItem(n)}function clearF(){localStorage.clear()}function checkFooterDestinations(){$.ajax({type:"GET",url:SiteName+"/Api/FooterDestinations/",contentType:"application/json; charset=utf-8",dataType:"json",success:function(n){msg=n;buildFooterDestinations(n)},error:function(n){alert(n.responseText+" = error")}})}function buildFooterDestinations(n){function i(n){switch(n){case 243:return"https://www.tripmasters.com/europe/";case 595:return"https://www.tripmasters.com/asia/";case 182:return"https://www.tripmasters.com/latin/";default:return"#"}}let t={countries:"",cities:""};const r=[...n].sort(function(n,t){return n.countryname.localeCompare(t.countryname)});$.each(r,function(){const n=i(this.regionid);t.countries+=`<li class="footer-destinations__item">
            <a href="${n+this.countryname.replace(/\s/g,"_").toLowerCase().trim()}/vacations">
                ${this.countryname.trim()}
            </a>
        </li>`});const u=[...n].sort(function(n,t){return n.cityname.localeCompare(t.cityname)});$.each(u,function(){const n=i(this.regionid);t.cities+=`<li class="footer-destinations__item">
            <a href="${n+this.cityname.replace(/\s/g,"_").toLowerCase().trim()}/vacations">
                ${this.cityname.trim()}
            </a>
        </li>`});let f=`<p class="footer-destinations__title"><a href="https://www.tripmasters.com/vacation-packages">Vacation Packages:</a></p>
                  ...
                  </div>`;$(".citylist").html(f+"<br/>")}function getRecentlyView(){var i=getItemF("objRecentlyView"),t,n;i!==null&&removeItemF("objRecentlyView");t={Id:visitID};n={};n.url=SiteName+"/Api/HeaderRecentlyViewed";n.type="POST";n.contentType="application/json; charset=utf-8";n.data=JSON.stringify(t);n.dataType="json";n.success=function(n){buildRecentlyViewedBase(n)};n.error=function(n){console.log(n)};$.ajax(n)}function buildRecentlyViewedBase(n){console.log(n);$("#dvMvisit").html("");var r=0,i,t="<div class='row w-100 mx-auto border-bottom'>";$.each(n,function(){if(r++,r<4){switch(this.UTS_Site){case"ED":i=location.protocol+"//www.europeandestinations.com";break;case"TMED":i=location.protocol+"//www.tripmasters.com/europe";break;case"TMASIA":i=location.protocol+"//www.tripmasters.com/asia";break;case"TMLD":i=location.protocol+"//www.tripmasters.com/latin";break;case"TMLUX":i=location.protocol+"//www.tripmasters.com/luxury"}var n=new Date(Date.parse(this.UTS_Date)),u=new Date,f=Date.timeBetween(n,u);t=t+'<li class="row liMostPop pl-0 pr-0 ml-0 mr-0 mb-2">';t=t+'<div class="col-4 pl-0 pr-0">';t=t+'<a href="'+i+"/"+this.STR_PlaceTitle.replace(/ /g,"_").toLowerCase()+"/"+this.PDL_Title.replace(/ /g,"_").toLowerCase()+"/package-"+this.PDLID+'">';t=t+'<img class="delay liImg" src="https://pictures.tripmasters.com'+this.IMG_Path_URL+'"/> ';t=t+"<\/a>";t=t+"<\/div>";t=t+'<div class="col-8">';t=t+'<div class="row pl-2 colTitle">';t=t+'<a href="'+i+"/"+this.STR_PlaceTitle.replace(/ /g,"_").toLowerCase()+"/"+this.PDL_Title.replace(/ /g,"_").toLowerCase()+"/package-"+this.PDLID+'">';t=t+this.PDL_Title;t=t+"<\/a>";t=t+"<\/div>";t=t+'<div class="Text_12_GrayLight dvSuggestPrice row" > Viewed '+f+"<\/span>";t=t+"<\/div>";t=t+"<\/div>";t=t+"<\/li>"}});$("#dvMvisit").append(t)}function showList(n){$("#meniu_"+n).is(":hidden")?($("#meniu_"+n).show(),$("#arrow_"+n).css({transform:"rotate(270deg)"})):($("#meniu_"+n).hide(),$("#arrow_"+n).css({transform:"rotate(90deg)"}))}function getMostPop(){var n=getItemF("objTMMostPop");n!==null?buildMostPop(n):$.ajax({type:"POST",url:SiteName+"/Api/HeaderMostPop",contentType:"application/json; charset=utf-8",dataType:"json",success:function(n){var t=n;setItemF("objTMMostPop",n,12);buildMostPop(n)},error:function(n){console.log(n.responseText+" = error")}})}function buildMostPop(n){var t="",i="";$.each(n,function(){var n=this;switch(n.deptNA){case"ED":i="www.tripmasters.com/europe";break;case"LD":i="www.tripmasters.com/latin";break;case"TMAS":i="www.tripmasters.com/asia"}t=t+'<li class="row liMostPop">';t=t+"<div>";t=t+'<a href="https://'+i+"/"+n.CountryNA.replace(/\s/g,"_").toLowerCase()+"/"+n.PDL_Title.replace(/\s/g,"_").toLowerCase()+"/package-"+n.PDLID+'">';t=t+'<img class="delay liImg" src="https://pictures.tripmasters.com'+n.IMG_Path_URL+'">';t=t+"<\/a>";t=t+"<\/div>";t=t+"<div>";t=t+'<a href="https://'+i+"/"+n.CountryNA.replace(/\s/g,"_").toLowerCase()+"/"+n.PDL_Title.replace(/\s/g,"_").toLowerCase()+"/package-"+n.PDLID+'">';t=t+n.PDL_Title;t=t+"<\/a>";t=t+'<p class="Text_12_GrayLight dvSuggestPrice">'+n.Duration+' nights from  <span class="spSuggestPrice"> $'+n.STP_Save+"*<\/span><\/p>";t=t+"<\/div>";t=t+"<\/li>"});$("#dvRelF").html(t);$("#dvRelFMob").html(t)}function addSubscribe(n){var t,i,r;$("#pnlSubscribe").hide();t=$.trim(n);t===""?t=$("#TMSubscribeEmail").val():"";i=1;r=0;$.ajax({type:"POST",url:"/Api/MarketingSubscriber",contentType:"application/json; charset=utf-8",dataType:"json",crossDomain:!0,data:JSON.stringify({email:t,ED:r,TM:i,proc:1,options:""}),success:function(n){n.success===!1?$("#pnlResult").html($("#pnlResult").html().replace("We have updated your subscription preferences.","Something went wrong, please try again later.")):"";$("#pnlResult").show()},error:function(){$("#pnlResult").html($("#pnlResult").html().replace("We have updated your subscription preferences.","Something went wrong, please try again later."));$("#pnlResult").show()}})}function getSubscribe(n){var t=$.trim(n);if(t===""?t=$.trim($("#SubscribedEmail").val()):"",t=decodeURIComponent(t),/%40/.test(t)?t=t.replace(/%40/,"@"):"",!isValidEmailAddress(t))return $("#SubscribedEmail").val("Valid email please"),$("#SubscribedEmail").focus().select(),!1;$.ajax({type:"POST",url:"/Api/MarketingSubscriber",contentType:"application/json; charset=utf-8",dataType:"json",data:JSON.stringify({email:t,ED:0,TM:0,proc:3,options:""}),success:function(n){n.success===!0?(/ED/.test(n.codes)?($("#SubscribeED").prop("checked",!0),$("#TxtSubsED").text("Subscribed")):($("#UnsubscribeED").prop("checked",!0),$("#TxtUnSubsED").text("Unsubscribed")),/TM/.test(n.codes)?($("#SubscribeTM").prop("checked",!0),$("#TxtSubsTM").text("Subscribed")):($("#UnsubscribeTM").prop("checked",!0),$("#TxtUnSubsTM").text("Unsubscribed"))):($("#UnsubscribeED").prop("checked",!0),$("#TxtUnSubsED").text("Unsubscribed"),$("#UnsubscribeTM").prop("checked",!0),$("#TxtUnSubsTM").text("Unsubscribed"))},error:function(n){console.log(n.responseText)}})}function updateSubscribe(){var n=getUrlVars().email,l;n=decodeURIComponent(n);/%40/.test(n)?n=n.replace(/%40/,"@"):"";var i=0,r=0,u=0,f=0,e=0,o=0,s=0,h=0,c="...",t=$("#Ideas").val();$("#SubscribeTM").is(":checked")?i=1:"";$("#SubscribeED").is(":checked")?r=1:"";$("#UnsubscribeTM").is(":checked")?u=1:"";$("#UnsubscribeED").is(":checked")?f=1:"";$("#R1").is(":checked")?e=1:"";$("#R2").is(":checked")?o=1:"";$("#R3").is(":checked")?s=1:"";$("#R4").is(":checked")?(h=1,c=$("#txtOtherReason").val()):"";t=t===""?"...":$("#Ideas").val();l=f+"@"+u+"@"+e+"@"+o+"@"+s+"@"+h+"@"+c+"@"+t;$.ajax({type:"POST",url:"/Api/MarketingSubscriber",contentType:"application/json; charset=utf-8",dataType:"json",crossDomain:!0,data:JSON.stringify({email:n,ED:r,TM:i,proc:2,options:l}),success:function(n){var t=n;$("#pnlSubscribe").hide();$("#pnlReason").hide();$("#pnlResult").show()},error:function(n){alert(n.responseText)}})}function centerPopup(){var i=$(window).width(),n=$(window).height(),t=$("#subscriptionpopup").height(),r=$("#subscriptionpopup").width();return $("#subscriptionpopup").css({position:"absolute",top:n/2-t/2+$(window).scrollTop()}),!1}function loadPopup(){popupStatus==0&&($("#subscriptionpopup").fadeIn("slow"),popupStatus=1)}function disablePopup(){return $(".subscriptionpopup").is(":visible")==!0?($("#subscriptionpopup").fadeOut("slow"),popupStatus=0):"",!1}function isValidEmailAddress(n){var t=new RegExp(/^(("[\w-+\s]+")|([\w-+]+(?:\.[\w-+]+)*)|("[\w-+\s]+")([\w-+]+(?:\.[\w-+]+)*))(@((?:[\w-+]+\.)*\w[\w-+]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$)|(@\[?((25[0-5]\.|2[0-4][\d]\.|1[\d]{2}\.|[\d]{1,2}\.))((25[0-5]|2[0-4][\d]|1[\d]{2}|[\d]{1,2})\.){2}(25[0-5]|2[0-4][\d]|1[\d]{2}|[\d]{1,2})\]?$)/i);return t.test(n)}function SubscribeEmailPopUp(n){var i=$("#"+n+"").val(),t;if(!isValidEmailAddress(i))return t=navigator.userAgent.match(/iPad/i)!=null,t==!0?($("#"+n+"").val(""),$("#"+n+"").focus().select(),alert("Valid email please")):($("#"+n+"").val("Valid email please"),$("#"+n+"").focus().select()),!1;$("#"+n).val($("#"+n).val());centerPopup();popupStatus==0&&($("#subscriptionpopup").fadeIn("slow"),addSubscribe(),popupStatus=1)}function unSubscribeReason(){if($("#UnsubscribeTM").is(":checked")||$("#UnsubscribeED").is(":checked"))$("#pnlSubscribe").hide(),$("#pnlReason").show(),$("#pnlResult").hide();else{var n=new URLSearchParams(window.location.search);addSubscribe(n.get("email"))}}function getUrlVars(){for(var t=[],n,r=window.location.href.slice(window.location.href.indexOf("?")+1).split("&"),i=0;i<r.length;i++)n=r[i].split("="),t.push(n[0]),t[n[0]]=n[1];return t}var _utCookie=utmValue,hvCook=0,_utDataIn,_utFunctions,_utRawUrl,_utRef,_utInputString,_utPlcIDs,_utEmail,utSiteNAparts,utSiteNA,utValues,utVisitorID,utMess,utVisCookStr,dateFormat,visitID,fileVersion,popupStatus;$(document).ready(function(){$(".closeAnn").click(function(){$(".secAnnounce").slideUp(function(){$(".dvImgContainer").css({margin:"0 auto",padding:"20px 0","max-width":"980px",height:"auto"})})});fetch(SiteName+"/Api/WebAnnouncement").then(n=>{if(!n.ok)throw new Error(`HTTP error! Status: ${n.status}`);return n.text()}).then(n=>{if(n!=""){var t='<section class="secTopAnnounce"><p class="closeTopAnn">X<\/p><img src="https://pictures.tripmasters.com/siteassets/d/attention_icon2.png" />'+n+"<\/section>";IsMobileDevice()==!0?_utInputString.includes("home")?($(".dvMhomeContainer").prepend(t),$(".secTopAnnounce").css({margin:"0px auto 0px auto",padding:"15px","max-width":"95%",background:"#333",color:"white"}),$(".closeTopAnn").click(function(){$(".secTopAnnounce").slideUp()})):($(".dvMhomeContainer").prepend(t),$(".secTopAnnounce").css({margin:"0px auto 0px auto",padding:"15px","max-width":"95%",background:"#333",color:"white"}).slideDown("fast"),$(".closeTopAnn").click(function(){$(".secTopAnnounce").slideUp("fast")})):_utInputString.includes("@@DFLT@@")?($(".dvContainer").prepend(t),$(".secTopAnnounce").css({margin:"0px auto 10px auto",padding:"25px",width:"930px",background:"#333",color:"white"}),$(".closeTopAnn").click(function(){$(".secTopAnnounce").slideUp(function(){$(".dvContainer").css({margin:"0 auto",height:"auto"})})})):_utInputString.includes("@@COU@@")?($(".dvContainer").prepend(t),$(".secTopAnnounce").css({margin:"0px auto 10px auto",padding:"25px",width:"930px",background:"#333",color:"white"}),$(".divImgContainer").css({padding:"0 0 30px 0","max-width":"980px",height:"auto"}),$(".closeTopAnn").click(function(){$(".secTopAnnounce").slideUp(function(){$(".divImgContainer").css({margin:"0 auto",padding:"70px 0 0",height:"auto"})})})):/@@CTY@@|@@PKG@@/.test(_utInputString)===!0&&($(".dvContainer").prepend(t),$(".secTopAnnounce").css({margin:"0 auto",padding:"30px",width:"918px",background:"#333",color:"white"}).slideDown("fast"),$(".closeTopAnn").click(function(){$(".secTopAnnounce").slideUp("fast")}))}}).catch(n=>{console.error("Error fetching Web Announcement:",n)})});document.addEventListener("DOMContentLoaded",function(){var n,t,i;if("IntersectionObserver"in window)n=Array.prototype.slice.call(document.querySelectorAll(".delay")),t=new IntersectionObserver(function(n){n.forEach(function(n){if(n.isIntersecting){var i=n.target;i.src=i.dataset.src;i.classList.remove("delay");t.unobserve(i)}})}),n.forEach(function(n){t.observe(n)});else{n=Array.prototype.slice.call(document.querySelectorAll(".delay"));function t(){i&&clearTimeout(i);i=setTimeout(function(){var i=window.pageYOffset;n.forEach(function(n){n.offsetTop<window.innerHeight+i&&(n.src=n.dataset.src,n.classList.remove("delay"))});n.length==0&&(document.removeEventListener("scroll",t),window.removeEventListener("resize",t),window.removeEventListener("orientationChange",t))},20)}document.addEventListener("scroll",t);window.addEventListener("resize",t);window.addEventListener("orientationChange",t)}});_utDataIn=_utDataIn||[];_utFunctions=_utFunctions||[];typeof _utRawUrl=="undefined"&&(_utRawUrl="");typeof _utRef=="undefined"&&(_utRef="");typeof _utInputString=="undefined"&&(_utInputString="");typeof _utPlcIDs=="undefined"&&(_utPlcIDs="");typeof _utEmail=="undefined"&&(_utEmail="");var _utArray=_utInputString.split("@@"),_utSiteName=function(){return typeof _utArray[0]=="undefined"?"":_utArray[0]}(),_utDeptID=function(){return typeof _utArray[1]=="undefined"?0:Number(_utArray[1])}(),_utUtmCampaign=function(){return typeof _utArray[2]=="undefined"?"direct":_utArray[2]}(),_utPgType=function(){if(typeof _utArray[3]=="undefined")return"";if(_utArray[3]==="")if(typeof _utArray[4].split("/")[1]!="undefined"){var n=_utArray[4].split("/")[1];n=n.toLowerCase().replace(".aspx","");switch(n){case"default":return"DFLT";case"about_us":return"ABOUT";case"contact_us":return"CONTACT";case"terms":return"TERMS";case"security-privacy":return"SECPRV";case"booking_confirmation":return"BKGCONF";case"bookingconfirmation":return"BKGCONF";case"insurance":return"INSURANCE";case"payments":return"PAY";case"airlineancillaryfees":return"AIRANCFEES";case"call_me_back":return"CALLBACK";case"AgentCall":return"AgentCall";default:return n.toUpperCase()}}else return"";else return _utArray[3]}(),_utPgTypeSuppID=function(){var n,i,t;switch(_utPgType){case"SLFDRV":case"MLTYCOU":case"CRUS":case"ARE":case"COU":case"COUS":case"DSTI":case"HOTonPLC":case"CTY":if(typeof _utArray[5]!="undefined")return Number(_utArray[5]);break;case"PKG":case"LUXPKG":if(typeof _utArray[6]!="undefined")return Number(_utArray[6]);break;case"INTRS":if(typeof _utArray[4]!="undefined"&&typeof _utArray[4].split("/")[3]!="undefined")return Number(_utArray[4].split("/")[3].replace("i",""));break;case"TKBY":if(typeof _utArray[4]!="undefined"){if(n=_utArray[4].indexOf("tkby"),n>=0)n=n+4;else return 0;return i=_utArray[4].indexOf("_",n),Number(_utArray[4].substring(n,i))}break;case"CFB":if(typeof _utArray[4]!="undefined"){if(typeof _utArray[4].split("/")[1]!="undefined"){if(t=_utArray[4].split("/")[1],n=t.toLowerCase().indexOf("cfb"),n>=0)n=n+3;else return 0;return i=t.indexOf("_",n),Number(t.substring(n,i))}return 0}break;case"TTBTLY":if(typeof _utArray[4]!="undefined"){if(typeof _utArray[4].split("/")[1]!="undefined"){if(t=_utArray[4].split("/")[1],n=t.toLowerCase().indexOf("ttbtly"),n>=0)n=n+6;else return 0;return i=t.indexOf("_",n),Number(t.substring(n,i))}return 0}break;case"HOT":if(typeof _utArray[4]!="undefined"&&_utArray[4].split("/")[2]!=="undefined"){if(t=_utArray[4].split("/")[2],n=t.toLowerCase().indexOf("hotel_description_pp"),n>=0)n=n+20;else return 0;return i=t.indexOf("_",n),Number(t.substring(n,i))}break;case"COMBCou":if(typeof _utArray[4]!="undefined"&&typeof _utArray[4].split("/")[1]!="undefined"&&(_utPlcIDs=_utArray[4].split("/")[1].replace("_",","),typeof _utArray[4].split("/")[1].split("_")[0]!="undefined"))return Number(_utArray[4].split("/")[1].split("_")[0]);break;case"MinPkg":if(typeof _utArray[4]!="undefined"&&typeof _utArray[4].split("/")[1]!="undefined"&&typeof _utArray[4].split("/")[1].split("_")[1]!="undefined")return Number(_utArray[4].split("/")[1].split("_")[1].replace("mpk",""));break;default:return 0}return 0}(),_utPlcID=function(){switch(_utPgType){case"CFB":case"TTBTLY":case"SLFDRV":case"CRUS":case"HOTonPLC":case"MLTYCOU":case"ARE":case"COU":case"COUS":case"DSTI":case"CTY":case"ChrmFPKG":if(_utArray[5]!=="undefined")return Number(_utArray[5]);case"INTRS":if(_utArray[4]!=="undefined"&&typeof _utArray[4].split("/")[2]!="undefined")return Number(_utArray[4].split("/")[2].toLowerCase().replace("c",""));break;default:return 0}return 0}(),_utProdItemID=function(){switch(_utPgType){case"PKG":case"mobilePKG":case"LUXPKG":if(_utArray[6]!=="undefined")return Number(_utArray[6]);default:return 0}}();(function(){_utDataIn.push(["_utCallType","Web"]);_utDataIn.push(["_utSiteName",_utSiteName]);_utDataIn.push(["_utPgType",_utPgType]);_utDataIn.push(["_utPgTypeSuppID",_utPgTypeSuppID]);_utDataIn.push(["_utPlcID",_utPlcID]);_utDataIn.push(["_utRef",_utRef]);_utDataIn.push(["_utUtmCampaign",_utUtmCampaign]);_utDataIn.push(["_utUrl",_utRawUrl]);_utDataIn.push(["_utProdItemID",_utProdItemID]);_utDataIn.push(["_utDeptID",_utDeptID]);_utDataIn.push(["_utPlcIDs",_utPlcIDs]);_utDataIn.push(["_utEmail",_utEmail])})();var img500=/-500.jpg|_500.jpg|500.jpg/g,isNumber=/[0-9]+/g,itisMobile=!1;jQuery.browser={},function(){jQuery.browser.msie=!1;jQuery.browser.version=0;navigator.userAgent.match(/MSIE ([0-9]+)\./)&&(jQuery.browser.msie=!0,jQuery.browser.version=RegExp.$1)}(),function(n){(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(n)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(n.substr(0,4)))&&(itisMobile=!0)}(navigator.userAgent||navigator.vendor||window.opera);utVisCookStr="";$(document).ready(function(){if(utSiteNAparts=_utInputString.split("@@"),utSiteNA=utSiteNAparts[0],Cookies.get("ut2")!=undefined){var n=Cookies.get("ut2").split("&"),t;n[0].indexOf("_utvId")>-1&&(t=n[0].split("="),utVisitorID=t[1])}else _ut2Functions.push(function(){utValues=_ut2;jQuery.each(utValues,function(n,t){n=="_utvId"&&(utVisitorID=t)})});$("#q").autocomplete({minLength:3,select:function(n,t){$("#q").val(t.item.value);searchGO(t.item.label)},source:function(n,t){var i={Id:n.term};$.ajax({url:SiteName+"/Api/amzCloud_Suggestions",type:"POST",data:JSON.stringify(i),contentType:"application/json; charset=utf-8",success:function(n){t($.map(n,function(n){return{label:n,value:n.substring(0,n.indexOf("##"))}}))},error:function(n){alert(n.responseText+" = error")}})}}).data("ui-autocomplete")._renderItem=function(n,t){var r=t.label.split("##"),u,i;return r[1].indexOf("inCt")!=-1?(i=$("<a><\/a>").html("<span>All "+r[0]+' packages (<\/span><span style="color:orange;font-weight:bold;">city<\/span>)'),$("<li><\/li>").append(i).appendTo(n)):r[1].indexOf("inCo")!=-1?(i=$("<a><\/a>").html("<span>All "+r[0]+' packages (<\/span><span style="color:orange;font-weight:bold;">country<\/span>)'),$("<li><\/li>").append(i).appendTo(n)):r[1].indexOf("Sp")!=-1?(i=$("<hr/>").css({border:"0",height:"1px","background-color":"lightgray"}),$('<li style="pointer-events:none;border:0;outline:none;padding:5px;margin:0px;width:95%!important;"><\/li>').append(i).appendTo(n)):r[3].indexOf("/luxury/")!=-1?(u=$("<span><\/span>").html("★").attr({id:"lux",style:"color:#b89723; font-size:0.95rem; padding-left:5px;"}),i=$("<a><\/a>").html(r[0]).attr("href","https://"+r[3].toLowerCase()+"?iSrc1=Header").append(u),highlightText(this.term,i),$("<li><\/li>").append(i).appendTo(n)):(i=$("<a><\/a>").text(r[0]).attr("href","https://"+r[3].toLowerCase()+"?iSrc1=Header"),highlightText(this.term,i),$("<li><\/li>").append(i).appendTo(n))}});jQuery.fn.center=function(){return this.css("position","fixed"),this.css("top","20px"),this.css("left","50%"),this.css("transform","translateX(-50%)"),this},function(){var i=new RegExp(/^(?=.*\b(iPad|iPhone|iPod|Macintosh)\b)(?=.*\b(Version)\b).*$/gm),r=new RegExp(/^(?=.*\b(iPad|iPhone|iPod|Macintosh)\b)(?!.*\b(Version|CriOS|EdiOS|FxiOS)\b).*$/gm),u=new RegExp(/Firefox\/\d+|FxiOS\/\d+|Fennec\/\d+/i),t="_blank",n;(window.navigator.userAgent.match(i)||window.navigator.userAgent.match(r)||window.navigator.userAgent.match(u))&&(t="_self");console.log(window.navigator.userAgent);n=document.getElementById("formToBooking");n!=undefined?n.setAttribute("target",t):""}(),function(){function i(i,r){i.forEach(i=>{i.isIntersecting&&!n&&(n=!0,t==!1&&checkFooterDestinations(),r.unobserve(i.target))})}let t=IsMobileDevice(),n=!1;const r=new IntersectionObserver(i,{root:null,threshold:.1}),u=document.getElementById("pgFooter");r.observe(u)}();dateFormat=function(){var t=/d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,i=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,r=/[^-+\dA-Z]/g,n=function(n,t){for(n=String(n),t=t||2;n.length<t;)n="0"+n;return n};return function(u,f,e){var h=dateFormat;if(arguments.length!=1||Object.prototype.toString.call(u)!="[object String]"||/\d/.test(u)||(f=u,u=undefined),u=u?new Date(u):new Date,isNaN(u))throw SyntaxError("invalid date");f=String(h.masks[f]||f||h.masks["default"]);f.slice(0,4)=="UTC:"&&(f=f.slice(4),e=!0);var o=e?"getUTC":"get",c=u[o+"Date"](),y=u[o+"Day"](),l=u[o+"Month"](),p=u[o+"FullYear"](),s=u[o+"Hours"](),w=u[o+"Minutes"](),b=u[o+"Seconds"](),a=u[o+"Milliseconds"](),v=e?0:u.getTimezoneOffset(),k={d:c,dd:n(c),ddd:h.i18n.dayNames[y],dddd:h.i18n.dayNames[y+7],m:l+1,mm:n(l+1),mmm:h.i18n.monthNames[l],mmmm:h.i18n.monthNames[l+12],yy:String(p).slice(2),yyyy:p,h:s%12||12,hh:n(s%12||12),H:s,HH:n(s),M:w,MM:n(w),s:b,ss:n(b),l:n(a,3),L:n(a>99?Math.round(a/10):a),t:s<12?"a":"p",tt:s<12?"am":"pm",T:s<12?"A":"P",TT:s<12?"AM":"PM",Z:e?"UTC":(String(u).match(i)||[""]).pop().replace(r,""),o:(v>0?"-":"+")+n(Math.floor(Math.abs(v)/60)*100+Math.abs(v)%60,4),S:["th","st","nd","rd"][c%10>3?0:(c%100-c%10!=10)*c%10]};return f.replace(t,function(n){return n in k?k[n]:n.slice(1,n.length-1)})}}();dateFormat.masks={"default":"ddd mmm dd yyyy HH:MM:ss",shortDate:"m/d/yy",mediumDate:"mmm d, yyyy",longDate:"mmmm d, yyyy",fullDate:"dddd, mmmm d, yyyy",shortTime:"h:MM TT",mediumTime:"h:MM:ss TT",longTime:"h:MM:ss TT Z",isoDate:"yyyy-mm-dd",isoTime:"HH:MM:ss",isoDateTime:"yyyy-mm-dd'T'HH:MM:ss",isoUtcDateTime:"UTC:yyyy-mm-dd'T'HH:MM:ss'Z'"};dateFormat.i18n={dayNames:["Sun","Mon","Tue","Wed","Thu","Fri","Sat","Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],monthNames:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec","January","February","March","April","May","June","July","August","September","October","November","December"]};Date.prototype.format=function(n,t){return dateFormat(this,n,t)};
/**
 * @license 
 ...
 */
(function(n){function i(t,i){var r=n(i);return r.length<2?r:t.parent().find(i)}function r(r,u){var f=this,s=r.add(f),e=r.children(),o=0,h=u.vertical,c,l,a,v;if(t||(t=f),e.length>1&&(e=n(u.items,r)),n.extend(f,{getConf:function(){return u},getIndex:function(){return o},getSize:function(){return f.getItems().length},getNaviButtons:function(){return a.add(v)},getRoot:function(){return r},getItemWrap:function(){return e},getItems:function(){return e.children(u.item).not("."+u.clonedClass)},move:function(n,t){return f.seekTo(o+n,t)},next:function(n){return f.move(1,n)},prev:function(n){return f.move(-1,n)},begin:function(n){return f.seekTo(0,n)},end:function(n){return f.seekTo(f.getSize()-1,n)},focus:function(){return t=f,f},addItem:function(t){return t=n(t),u.circular?(n(".cloned:last").before(t),n(".cloned:first").replaceWith(t.clone().addClass(u.clonedClass))):e.append(t),s.trigger("onAddItem",[t]),f},seekTo:function(i,r,c){var l,a,v;return u.circular&&i===0&&o==-1&&r!==0?f:!u.circular&&i<0||i>f.getSize()||i<-1?f:(l=i,i.jquery?i=f.getItems().index(i):l=f.getItems().eq(i),a=n.Event("onBeforeSeek"),!c&&(s.trigger(a,[i,r]),a.isDefaultPrevented()||!l.length))?f:(v=h?{top:-l.position().top}:{left:-l.position().left},o=i,t=f,r===undefined&&(r=u.speed),e.animate(v,r,u.easing,c||function(){s.trigger("onSeek",[i])}),f)}}),n.each(["onBeforeSeek","onSeek","onAddItem"],function(t,i){n.isFunction(u[i])&&n(f).bind(i,u[i]);f[i]=function(t){return n(f).bind(i,t),f}}),u.circular){c=f.getItems().slice(-1).clone().prependTo(e);l=f.getItems().eq(1).clone().appendTo(e);c.add(l).addClass(u.clonedClass);f.onBeforeSeek(function(n,t,i){if(!n.isDefaultPrevented()){if(t==-1)return f.seekTo(c,i,function(){f.end(0)}),n.preventDefault();t==f.getSize()&&f.seekTo(l,i,function(){f.begin(0)})}});f.seekTo(0,0)}if(a=i(r,u.prev).click(function(){f.prev()}),v=i(r,u.next).click(function(){f.next()}),!u.circular&&f.getSize()>1)f.onBeforeSeek(function(n,t){setTimeout(function(){n.isDefaultPrevented()||(a.toggleClass(u.disabledClass,t<=0),v.toggleClass(u.disabledClass,t>=f.getSize()-1))},1)});u.mousewheel&&n.fn.mousewheel&&r.mousewheel(function(n,t){if(u.mousewheel)return f.move(t<0?1:-1,u.wheelSpeed||50),!1});u.keyboard&&n(document).bind("keydown.scrollable",function(i){if(u.keyboard&&!i.altKey&&!i.ctrlKey&&!n(i.target).is(":input")&&(u.keyboard=="static"||t==f)){var r=i.keyCode;return h&&(r==38||r==40)?(f.move(r==38?-1:1),i.preventDefault()):!h&&(r==37||r==39)?(f.move(r==37?-1:1),i.preventDefault()):void 0}});n(f).trigger("onBeforeSeek",[u.initialIndex])}n.tools=n.tools||{version:"1.2.3"};n.tools.scrollable={conf:{activeClass:"active",circular:!1,clonedClass:"cloned",disabledClass:"disabled",easing:"swing",initialIndex:0,item:null,items:".items",keyboard:!0,mousewheel:!1,next:".next",prev:".prev",speed:400,vertical:!1,wheelSpeed:0}};var t;n.fn.scrollable=function(t){var i=this.data("scrollable");return i?i:(t=n.extend({},n.tools.scrollable.conf,t),this.each(function(){i=new r(n(this),t);n(this).data("scrollable",i)}),t.api?i:this)}})(jQuery),function(n){var t={init:function(i){var r=n.extend({items:1,itemsOnPage:1,pages:0,displayedPages:5,edges:2,currentPage:0,hrefTextPrefix:"#page-",hrefTextSuffix:"",prevText:"Prev",nextText:"Next",ellipseText:"&hellip;",cssStyle:"light-theme",labelMap:[],selectOnClick:!0,nextAtFront:!1,invertPageOrder:!1,useStartEdge:!0,useEndEdge:!0,onPageClick:function(){},onInit:function(){}},i||{}),u=this;return r.pages=r.pages?r.pages:Math.ceil(r.items/r.itemsOnPage)?Math.ceil(r.items/r.itemsOnPage):1,r.currentPage=r.currentPage?r.currentPage-1:r.invertPageOrder?r.pages-1:0,r.halfDisplayed=r.displayedPages/2,this.each(function(){u.addClass(r.cssStyle+" simple-pagination").data("pagination",r);t._draw.call(u)}),r.onInit(),this},selectPage:function(n){return t._selectPage.call(this,n-1),this},prevPage:function(){var n=this.data("pagination");return n.invertPageOrder?n.currentPage<n.pages-1&&t._selectPage.call(this,n.currentPage+1):n.currentPage>0&&t._selectPage.call(this,n.currentPage-1),this},nextPage:function(){var n=this.data("pagination");return n.invertPageOrder?n.currentPage>0&&t._selectPage.call(this,n.currentPage-1):n.currentPage<n.pages-1&&t._selectPage.call(this,n.currentPage+1),this},getPagesCount:function(){return this.data("pagination").pages},getCurrentPage:function(){return this.data("pagination").currentPage+1},destroy:function(){return this.empty(),this},drawPage:function(n){var i=this.data("pagination");return i.currentPage=n-1,this.data("pagination",i),t._draw.call(this),this},redraw:function(){return t._draw.call(this),this},disable:function(){var n=this.data("pagination");return n.disabled=!0,this.data("pagination",n),t._draw.call(this),this},enable:function(){var n=this.data("pagination");return n.disabled=!1,this.data("pagination",n),t._draw.call(this),this},updateItems:function(n){var i=this.data("pagination");i.items=n;i.pages=t._getPages(i);this.data("pagination",i);t._draw.call(this)},updateItemsOnPage:function(n){var i=this.data("pagination");return i.itemsOnPage=n,i.pages=t._getPages(i),this.data("pagination",i),t._selectPage.call(this,0),this},_draw:function(){var i=this.data("pagination"),r=t._getInterval(i),u,s,f,o,e;if(t.destroy.call(this),s=typeof this.prop=="function"?this.prop("tagName"):this.attr("tagName"),f=s==="UL"?this:n("<ul><\/ul>").appendTo(this),i.prevText&&t._appendItem.call(this,i.invertPageOrder?i.currentPage+1:i.currentPage-1,{text:i.prevText,classes:"prev"}),i.nextText&&i.nextAtFront&&t._appendItem.call(this,i.invertPageOrder?i.currentPage-1:i.currentPage+1,{text:i.nextText,classes:"next"}),i.invertPageOrder){if(r.end<i.pages&&i.edges>0){if(i.useStartEdge)for(o=Math.max(i.pages-i.edges,r.end),u=i.pages-1;u>=o;u--)t._appendItem.call(this,u);i.pages-i.edges>r.end&&i.pages-i.edges-r.end!=1?f.append('<li class="disabled"><span class="ellipse">'+i.ellipseText+"<\/span><\/li>"):i.pages-i.edges-r.end==1&&t._appendItem.call(this,r.end)}}else if(r.start>0&&i.edges>0){if(i.useStartEdge)for(e=Math.min(i.edges,r.start),u=0;u<e;u++)t._appendItem.call(this,u);i.edges<r.start&&r.start-i.edges!=1?f.append('<li class="disabled"><span class="ellipse">'+i.ellipseText+"<\/span><\/li>"):r.start-i.edges==1&&t._appendItem.call(this,i.edges)}if(i.invertPageOrder)for(u=r.end-1;u>=r.start;u--)t._appendItem.call(this,u);else for(u=r.start;u<r.end;u++)t._appendItem.call(this,u);if(i.invertPageOrder){if(r.start>0&&i.edges>0&&(i.edges<r.start&&r.start-i.edges!=1?f.append('<li class="disabled"><span class="ellipse">'+i.ellipseText+"<\/span><\/li>"):r.start-i.edges==1&&t._appendItem.call(this,i.edges),i.useEndEdge))for(e=Math.min(i.edges,r.start),u=e-1;u>=0;u--)t._appendItem.call(this,u)}else if(r.end<i.pages&&i.edges>0&&(i.pages-i.edges>r.end&&i.pages-i.edges-r.end!=1?f.append('<li class="disabled"><span class="ellipse">'+i.ellipseText+"<\/span><\/li>"):i.pages-i.edges-r.end==1&&t._appendItem.call(this,r.end),i.useEndEdge))for(o=Math.max(i.pages-i.edges,r.end),u=o;u<i.pages;u++)t._appendItem.call(this,u);i.nextText&&!i.nextAtFront&&t._appendItem.call(this,i.invertPageOrder?i.currentPage-1:i.currentPage+1,{text:i.nextText,classes:"next"})},_getPages:function(n){var t=Math.ceil(n.items/n.itemsOnPage);return t||1},_getInterval:function(n){return{start:Math.ceil(n.currentPage>n.halfDisplayed?Math.max(Math.min(n.currentPage-n.halfDisplayed,n.pages-n.displayedPages),0):0),end:Math.ceil(n.currentPage>n.halfDisplayed?Math.min(n.currentPage+n.halfDisplayed,n.pages):Math.min(n.displayedPages,n.pages))}},_appendItem:function(i,r){var s=this,f,e,u=s.data("pagination"),o=n("<li><\/li>"),h=s.find("ul");i=i<0?0:i<u.pages?i:u.pages-1;f={text:i+1,classes:""};u.labelMap.length&&u.labelMap[i]&&(f.text=u.labelMap[i]);f=n.extend(f,r||{});i==u.currentPage||u.disabled?(u.disabled?o.addClass("disabled"):o.addClass("active"),e=n('<span class="current">'+f.text+"<\/span>")):(e=n('<a href="'+u.hrefTextPrefix+(i+1)+u.hrefTextSuffix+'" class="page-link">'+f.text+"<\/a>"),e.click(function(n){return t._selectPage.call(s,i,n)}));f.classes&&e.addClass(f.classes);o.append(e);h.length?h.append(o):s.append(o)},_selectPage:function(n,i){var r=this.data("pagination");r.currentPage=n;r.selectOnClick&&t._draw.call(this);return r.onPageClick(n+1,i)}};n.fn.pagination=function(i){if(t[i]&&i.charAt(0)!="_")return t[i].apply(this,Array.prototype.slice.call(arguments,1));if(typeof i!="object"&&i)n.error("Method "+i+" does not exist on jQuery.pagination");else return t.init.apply(this,arguments)}}(jQuery);$(document).ready(function(){var n,t;Cookies.get("ut2")!=undefined?(n=Cookies.get("ut2").split("&"),t=n[0].split("="),visitID=t[1]):_ut2Functions.push(function(){utValues=_ut2;jQuery.each(utValues,function(n,t){n=="_utvId"&&(visitID=t)})});$(".deskDestinations").click(function(){$("#destinationsContent").is(":visible")===!1?($("#destinationsContent").slideDown(),$("#manageContent").hide(),$("#whoContent").hide(),$("#des").css({transform:"rotate(270deg)"}),$("#book").css({transform:"rotate(90deg)"}),$("#contact").css({transform:"rotate(90deg)"})):($("#destinationsContent").slideUp(),$("#des").css({transform:"rotate(90deg)"}));getMostPop();$(".dvCloseDesk").click(function(){$("#destinationsContent").slideUp();$("#des").css({transform:"rotate(90deg)"});$("li.deskDestinations").removeClass("navTriangle")});$("li.deskMyBooking").removeClass("navTriangle");$("li.deskContact").removeClass("navTriangle");$("li.navTriangle").length?$("li.deskDestinations").removeClass("navTriangle"):$("li.deskDestinations").addClass("navTriangle")});$(".deskMyBooking").click(function(){$("#manageContent").is(":visible")===!1?($("#manageContent").slideDown(),$("#destinationsContent").hide(),$("#whoContent").hide(),$("#book").css({transform:"rotate(270deg)"}),$("#des").css({transform:"rotate(90deg)"}),$("#contact").css({transform:"rotate(90deg)"})):($("#manageContent").slideUp(),$("#book").css({transform:"rotate(90deg)"}));getRecentlyView();$(".dvCloseBook").click(function(){$("#whoContent").slideUp();$("#book").css({transform:"rotate(90deg)"});$("li.deskMyBooking").removeClass("navTriangle")});$("li.deskDestinations").removeClass("navTriangle");$("li.deskContact").removeClass("navTriangle");$("li.navTriangle").length?$("li.deskMyBooking").removeClass("navTriangle"):$("li.deskMyBooking").addClass("navTriangle")});$(".deskContact").click(function(){$("#whoContent").is(":visible")===!1?($("#whoContent").slideDown(),$("#destinationsContent").hide(),$("#manageContent").hide(),$("#contact").css({transform:"rotate(270deg)"}),$("#des").css({transform:"rotate(90deg)"}),$("#book").css({transform:"rotate(90deg)"})):($("#whoContent").slideUp(),$("#contact").css({transform:"rotate(90deg)"}));$(".dvCloseWho").click(function(){$("#whoContent").slideUp();$("#contact").css({transform:"rotate(90deg)"});$("li.deskContact").removeClass("navTriangle")});$("li.deskDestinations").removeClass("navTriangle");$("li.deskMyBooking").removeClass("navTriangle");$("li.navTriangle").length?$("li.deskContact").removeClass("navTriangle"):$("li.deskContact").addClass("navTriangle")});$(".btnMob").click(function(){$(".navBarMob").is(":visible")===!1?($(".navBarMob").slideDown(600),$(".hdrBrand").css("background-color","#eeeff3"),$(".site-search__mob").css({"background-color":"unset"})):($(".navBarMob, .worldRegion,.packagesRes, .mostPopRes, .myBookings, .contactUs").slideUp(600),$(".hdrBrand").css("background-color","transparent"),$(".site-search__mob").css({"background-color":"#1A2360"}))});$(".acetrnt-toggle").click(function(){$(this).toggleClass("active")});$(".thtitleRes").click(function(){var n=$(this).attr("id");n==undefined?/who/i.test(this.textContent)?n=1:/additional/i.test(this.textContent)?n=2:/secured/i.test(this.textContent)?n=3:"":"";showList(n)});$("#worldReg").click(function(){thisPos=$(this).offset().top;$(".worldRegion").show("slide",{direction:"right"},"slow");window.scrollTo(0,0)});$("#packages").click(function(){thisPos=$(this).offset().top;$(".packagesRes").show("slide",{direction:"right"},"slow");window.scrollTo(0,0)});$("#mostPop").click(function(){thisPos=$(this).offset().top;$(".mostPopRes").show("slide",{direction:"right"},"slow");window.scrollTo(0,0);getMostPop()});$("#myBooking").click(function(){thisPos=$(this).offset().top;$(".myBookings").show("slide",{direction:"right"},"slow");window.scrollTo(0,0)});$("#contactUs").click(function(){thisPos=$(this).offset().top;$(".contactUs").show("slide",{direction:"right"},"slow");window.scrollTo(0,0)});$(".dvBackRes").click(function(){$(".worldRegion").hide("slide",{direction:"right"},"slow");$(".packagesRes").hide("slide",{direction:"right"},"slow");$(".mostPopRes").hide("slide",{direction:"right"},"slow");$(".myBookings").hide("slide",{direction:"right"},"slow");$(".contactUs").hide("slide",{direction:"right"},"slow");window.scrollTo(0,0)});$(".dvMtopPage").click(function(){$("html, body").animate({scrollTop:0},200)})});Date.timeBetween=function(n,t){var e=n.getTime(),o=t.getTime(),i=o-e,s,r,u,f;return i=i/1e3,s=Math.floor(i%60),i=i/60,r=Math.floor(i%60),i=i/60,u=Math.floor(i%24),f=Math.floor(i/24),f>0?f===1?f+" day ago":f+" days ago":u>0?u===1?u+" hour ago":u+" hours ago":r>0?r===1?r+" minute ago":r+" minutes ago":"  just visited"};
//! moment.js
//! version : 2.29.1
...
//! moment.js
return t.version="2.29.1",ih(l),t.fn=n,t.min=nv,t.max=tv,t.now=bo,t.utc=ot,t.unix=vw,t.months=pw,t.isDate=pi,t.locale=gt,t.invalid=rr,t.duration=et,t.isMoment=ut,t.weekdays=bw,t.parseZone=yw,t.localeData=bt,t.isDuration=tu,t.monthsShort=ww,t.weekdaysMin=dw,t.defineLocale=ff,t.updateLocale=na,t.locales=ta,t.weekdaysShort=kw,t.normalizeUnits=tt,t.relativeTimeRounding=fk,t.relativeTimeThreshold=ek,t.calendarFormat=ny,t.prototype=n,t.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},t});fileVersion=8012022;popupStatus=0;$(document).ready(function(){$("#subscriptionpopup").hide();$("#pnlResult").hide();$("#SubscribeSubmit").click(function(){addSubscribe()});$("#FindSubscription").click(function(){getSubscribe()});$("#SubmitReasons").click(function(){unSubscribeReason()});$("#UpdateSbscriptionButton").click(function(){updateSubscribe()});$("#SubscribeAll").click(function(){$("#SubscribeAll").is(":checked")?($("#SubscribeED").prop("checked",!0),$("#SubscribeTM").prop("checked",!0)):($("#SubscribeED").prop("checked",!1),$("#SubscribeTM").prop("checked",!1))});$("#UnsubscribeAll").click(function(){var n=$("#UnsubscribeAll").is(":checked");$("#UnsubscribeAll").is(":checked")?($("#UnsubscribeED").prop("checked",!0),$("#UnsubscribeTM").prop("checked",!0)):($("#UnsubscribeED").prop("checked",!1),$("#UnsubscribeTM").prop("checked",!1))});$("#UnsubscribeED").click(function(){$("#SubscribeED").prop("checked",!1);$("#TxtSubsED").text("Subscribe")});$("#UnsubscribeTM").click(function(){$("#SubscribeTM").prop("checked",!1);$("#TxtSubsTM").text("Subscribe")});$("#SubscribeED").click(function(){$("#UnsubscribeED").prop("checked",!1);$("#TxtUnSubsED").text("Unsubscribe")});$("#SubscribeTM").click(function(){$("#UnsubscribeTM").prop("checked",!1);$("#TxtUnSubsTM").text("Unsubscribe")});$("#SubscribeMainSite").click(function(n){return n.preventDefault(),$("#subscriptionpopup").hide(),!1});$(".subscriptionpopupClose").click(function(){return disablePopup(),!1})});