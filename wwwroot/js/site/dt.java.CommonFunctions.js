...
function checkCalendar(userHomeTown) {
    ...
    switch (rgx) {
        case 'idLeavingFrom':
            if ($('#idLeavingFrom').val() == "-1" || $('#idLeavingFrom').val() == "") {
        ...
        case 'qReturnID':
            ...
            break;
        case 'iDepCity':
            if ($('#iDepCity').val() == "-1" || $('#iDepCity').val() == "") {
                $('#sDepCity').val(town[1]);
                $('#iDepCity').val(town[0]);
            ...
            break;
        case 'xIDLeavingFrom':
            if ($('#xIDLeavingFrom').val() == "-1" || $('#xIDLeavingFrom').val() == "") {
...
(function () {
    ...
    form != undefined ? form.setAttribute("target", targetOpt) : '';
})();
// ---------------------------------
...
function setItemF(key, value, hs) {
    var maxAge = hs * 60 * 60 * 1000;
